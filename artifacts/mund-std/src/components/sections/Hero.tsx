...
import heroImgUrl from "@assets/626467322_17934961971161771_3662617065775760134_n._1777806036053.jpg";
    ...
    <section id="hero" className="relative w-full min-h-screen flex flex-col justify-between pt-32 pb-12 px-6 md:px-12 xl:px-24 overflow-hidden">
      <div className="flex-1 flex flex-col justify-center relative z-10 w-full">
        ...
        <motion.div
          ...
          className="absolute top-0 right-0 text-[15px] font-mono uppercase tracking-widest text-foreground/60 flex flex-col items-end gap-1"
        >
        ...
        >
          ...
          <p className="font-mono uppercase tracking-[0.25em] text-[15px] text-foreground/55 mt-6 max-w-3xl">
            <span>fleurs vivantes,</span> volumes architecturés.
          </p>
          <div className="mt-8 flex flex-col md:flex-row md:items-end justify-between gap-8 w-full max-w-4xl">
            <p className="font-mono text-[15px] uppercase tracking-[0.2em] max-w-[200px] leading-none text-foreground/80">
        ...
        >
          <div className="relative aspect-[3/4] bg-muted shadow-xl">
            ...
            />
            <div className="absolute -bottom-6 -left-6 text-[15px] font-mono tracking-widest uppercase rotate-[-90deg] origin-bottom-left text-foreground/70">
              00 — COVER
            </div>
          </div>
        </motion.div>
      ...
      >
        <span className="text-[15px] font-mono tracking-widest uppercase">Liège, BE</span>
        <span className="text-[15px] font-mono tracking-widest uppercase">mund.be</span>
      </motion.div>
    </section>
  );
}
